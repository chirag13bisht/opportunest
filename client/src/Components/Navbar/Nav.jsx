...
const Nav = () => {
    ...
    const emailCheck = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:5000/api/auth/emailCheck', { email });
    ...
    const passwordCheck = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:5000/api/auth/logup', { email, password }, { withCredentials: true });
